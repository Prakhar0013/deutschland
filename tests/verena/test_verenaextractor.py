...
def test_extractor_content():
    with open("tests/verena/ausschreibung_test_input.html", "r",encoding="utf-8") as f:
        with open("tests/verena/ausschreibung_correct_result.json", "r",encoding="utf-8") as correct:
